  ...
  return (
    <main className="dashboard" id="network">
      ...
      <div className="network-overview">
        ...
        <Panel className="network-box network-throughput" title="Throughput" eyebrow="PVE-01 / GLANCES" severity="OK" freshness="CURRENT"><MirroredTrafficGraph upload={pveTx} download={pveRx} unit="Mb/s" /><span className="metric-detail">Host bridge traffic; upload is above the baseline and download is below it.</span></Panel>
