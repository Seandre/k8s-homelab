...
| IE-004 HA k3s foundation | **IMPLEMENTED; LIVE ACCEPTANCE PENDING** | IE-003 | Argo is Synced/Healthy; private onboarding works; the 10 GiB writable state survives replacement; prior-image rollback is proven; only initial ingress/DNS/external-HTTPS paths exist. |
