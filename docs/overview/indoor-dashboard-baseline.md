...
| IE-007 Nest | **PREPARED; OWNER GATE PENDING** | IE-004 plus owner OAuth/Device Access gate | Official integration reads and controls every advertised capability; cloud loss is unavailable, and unsupported features are absent. |
