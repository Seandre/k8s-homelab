...
| IE-008 Coway live onboarding | **LIVE; CLOUD-LOSS ACCEPTANCE PENDING** | IE-002 and IE-004; owner credential gate complete | Both units independently pass readings, filters, power, speeds, presets, timers, lights, lock, and sensitivity with exact restoration; scoped cloud-loss behavior remains. |
