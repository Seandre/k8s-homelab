...
git add \
  ...
  docs/operations/stable-admin-credentials.md \
  docs/overview/documentation-order.md \
  docs-site/vitepress/.vitepress/config.mjs \
  README.md
