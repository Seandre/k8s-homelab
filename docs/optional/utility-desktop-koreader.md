...
Complete [Build 02: Utility Automation Server](../build/utility-automation-server.md) first. This desktop is optional and is not required for [Build 04: Compact OKD](../build/compact-okd.md).
